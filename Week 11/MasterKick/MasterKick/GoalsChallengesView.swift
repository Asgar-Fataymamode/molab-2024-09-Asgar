...
struct GoalsChallengesView: View {
    ...
    @State private var selectedGoal: Goal?
    @State private var showGoalDetails = false
    @State private var navigateToSkills = false  // State to navigate to SkillListView
        ...
        NavigationStack {
            ScrollViewReader { proxy in
                    ...
                    VStack(spacing: 20) {
                        ...
                        Button(action: {
                            withAnimation {
                                ...
                                proxy.scrollTo("skillsSection", anchor: .bottom) // Scroll animation
                            }
                        }) {
                            Text("Explore Skills")
                                .font(.headline)
                        ...
                        .padding(.horizontal)
                        .id("skillsSection") // Identifier for scrolling
                ...
                .navigationDestination(isPresented: $navigateToSkills) {
                    SkillListView(skills: skills)  // Navigate to SkillListView
                }
            }
        }
    }
...
// Models and Views for Goals (unchanged)
struct Goal: Identifiable {
    let id = UUID()
    var name: String
    var progress: Double
